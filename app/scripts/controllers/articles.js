...
/**
 * @ngdoc function
 * @name healthliveApp.controller:ArticlesCtrl
 * @description
 * # ArticlesCtrl
...
angular.module('healthliveApp')
  .controller('ArticlesCtrl', function ($scope) {
    $scope.posts = [
			...
			content:'Almonds contain high amounts of HDL which helps reduce cholestrol.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus rhoncus quam leo, id tristique sapien viverra eu. Maecenasipsum lectus, suscipit auctor tristique in, venenatis ut nisl. Quisqueeget bibendum libero. Nam nec mi augue.' 
			},
			{
